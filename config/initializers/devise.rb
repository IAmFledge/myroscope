...
Devise.setup do |config|
  ...
  # config.secret_key
  #   = '19560a7ae2ac0e146cfe0221c2dd3eb7b4af2621edca6882de348139857b21675f' \
  #     '9df34886c2c44ee04b350fed69f3e3e603d9e6240a7415fe1c37ed9ed7c808'
  ...
  config.mailer_sender = 'hello@myroscope.com'
  ...
  # model lookup. For instance, if you set :request_keys to
  ...
  # However, it is STRONGLY RECOMMENDED to not use a value less than 10
  # in other environments. Note that, for bcrypt (the default
  ...
  # config.pepper
  #   = '73fa93a3e40ea9cd2339c1d4723b9aaab4eb1f89ac4a7da4bc01fcbbf108' \
  #     '5b3805004578d1bf038fea362508aec2df85b89cbf576deb43892e220e404cdab376'
